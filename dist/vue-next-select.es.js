...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  , ["modelValue", "placeholder", "disabled", "tabindex", "autofocus"]), renderSlot(_ctx.$slots, "append")]);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock("div", mergeProps({
    ...
    onKeypress: _cache[12] || (_cache[12] = withKeys(function () {
    ...
    }, ["prevent"]), ["down"])), _cache[14] || (_cache[14] = withKeys(withModifiers(function () {
  ...
  /* PROPS */
  , ["modelValue", "collapse-tags", "onClick"]), createVNode("span", {
  ...
  /* PROPS */
  , ["modelValue", "disabled", "placeholder", "onInput", "onChange", "onFocus", "onBlur", "onEscape", "autofocus", "tabindex"])) : createCommentVNode("v-if", true), withDirectives(createVNode("span", _hoisted_3, [_hoisted_4, _hoisted_5, _hoisted_6], 512
  /* NEED_PATCH */
  ...
  /* PROPS */
  , ["modelValue", "disabled", "placeholder", "onInput", "onChange", "onFocus", "onBlur", "onEscape", "tabindex", "autofocus"])), [[vShow, _ctx.isFocusing]]) : createCommentVNode("v-if", true), withDirectives(createVNode(_component_v_dropdown, {
    ref: "dropdown",
    modelValue: _ctx.optionsWithInfo,
